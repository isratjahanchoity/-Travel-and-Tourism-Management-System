...
public class AddCustomer extends JFrame implements ActionListener {
    ...
    AddCustomer(String username) {
        ...
        comboid = new JComboBox(new String[]{"Passport", "NID Card", "Driving License", "Ration Card"});
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/newcustomer7.jpeg"));
