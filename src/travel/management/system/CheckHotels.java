...
public class CheckHotels extends JFrame implements Runnable{
    ...
    public void run () {
        String [] text = new String [] {"The Grand Terrace", "Sea Pearl Beach Resort Spa" ,  "The Palace Luxury", "Ocean Paradise Hotel", "Hotel Fountain","Dream Square Resort", "Sayeman Beach Resort",  "Best Western Heritage", "Neeshorgo Hotel & Resort", "Bandarban Hill Resort" };
        try {
