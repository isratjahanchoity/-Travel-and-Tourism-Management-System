...
//    }
    ...
    public DeleteCustomer() throws SQLException {
        ...
        JLabel lblCheckInStatus = new JLabel("Phone Number :");
        ...
        b1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Conn c = new Conn();
                try {
                    String selectedUsername = c1.getSelectedItem(); // Get the selected username from Choice
                    ResultSet rs = c.s.executeQuery("select * from customer where username = '" + selectedUsername + "'");
                    if (rs.next()) {
                        l2.setText(rs.getString(2)); // ID
                        l3.setText(rs.getString(3)); // Number
                        l4.setText(rs.getString(4)); // Name
                        l5.setText(rs.getString(5)); // Gender
                        l6.setText(rs.getString(6)); // Country
                        l7.setText(rs.getString(7)); // Address
                        l8.setText(rs.getString(8)); // Phone Number
                        l9.setText(rs.getString(9)); // Email
                    }
                } catch (Exception ee) {
                    ee.printStackTrace();
                }
