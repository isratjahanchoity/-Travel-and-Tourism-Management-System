...
public class DeleteDetails extends JFrame implements ActionListener {
    ...
    DeleteDetails(String username) {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/viewall3.jpeg"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/viewall3.jpeg"));
        Image i5 = i4.getImage().getScaledInstance(600, 200, Image.SCALE_DEFAULT);
        ImageIcon i6 = new ImageIcon(i5);
        JLabel image2 = new JLabel(i6);
        image2.setBounds(20, 400, 600, 200);
        add(image2);
    ...
    public static void main(String[] args) {
      // new DeleteDetails("");
       //new DeleteDetails("");
        new DeleteDetails("Israt Jahan Choity");
